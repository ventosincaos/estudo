         ...
         <div class="page-wrap">
            ...
            <div class="form-wrap d-flex justify-content-center">
               ...
               <form id="cadastro" action="" method="POST">
                  ...
                  <!-- data de ingresso, semestre e curso -->
                  <div class="row">
                     <label>
               ...
               <table class="table table-bordered table-hover">
                  ...
                  PQ SEM ISSO NÃO DÁ PRA EXCLUIR BB -->
                              ...
                              <div class="btn-group" role="group" aria-label="Basic example">
                                 <button class="btn btn-outline-primary" onclick="window.location.href='../pages-crud/form-crd.php?id=<?php echo $dados[$i]['id']; ?>'">
                                 ...
                                 if (isset($_GET['id']) && !empty($_GET["id"])) {
                                    $id = addslashes($_GET['id']); #adiciona a barrinha invertida 
                                    $p->excluirAluno($id); #ativa a function
                                    header('Location: ../pages-crud/form-crd.php');
                                    exit(); // Encerra o script para garantir que a exclusão seja registrada
                                 }
                                 ?>

                                 <button class="btn btn-outline-primary " onclick="window.location.href='../pages-crud/form-u.php?id=<?php echo $dados[$i]['id']; ?>'">
